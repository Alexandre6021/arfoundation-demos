...
IL_0164:
	{
		...
		L_52 = VirtualFuncInvoker0< Camera_tA92CC927D7439999BC82DBEDC0AA45B470F9E184* >::Invoke(18 /* UnityEngine.Camera UnityEngine.EventSystems.BaseRaycaster::get_eventCamera() */, __this);
		NullCheck(L_52);
		...
		float L_59;
		L_59 = Vector3_Distance_m99C722723EDD875852EF854AD7B7C4F8AC4F84AB_inline(L_54, L_58, NULL);
		(&V_18)->___distance_2 = L_59;
		RaycastHit2DU5BU5D_t28739C686586993113318B63C84927FD43063FC7* L_60 = __this->___m_Hits_11;
		int32_t L_61 = V_10;
		NullCheck(L_60);
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7 L_62;
		L_62 = RaycastHit2D_get_point_mB35E988E9E04328EFE926228A18334326721A36B(((L_60)->GetAddressAt(static_cast<il2cpp_array_size_t>(L_61))), NULL);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_63;
		L_63 = Vector2_op_Implicit_mCD214B04BC52AED3C89C3BEF664B6247E5F8954A_inline(L_62, NULL);
		(&V_18)->___worldPosition_7 = L_63;
		RaycastHit2DU5BU5D_t28739C686586993113318B63C84927FD43063FC7* L_64 = __this->___m_Hits_11;
		int32_t L_65 = V_10;
		NullCheck(L_64);
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7 L_66;
		L_66 = RaycastHit2D_get_normal_m75F1EBDE347BACEB5A6A6AA72543C740806AB5F2(((L_64)->GetAddressAt(static_cast<il2cpp_array_size_t>(L_65))), NULL);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_67;
		L_67 = Vector2_op_Implicit_mCD214B04BC52AED3C89C3BEF664B6247E5F8954A_inline(L_66, NULL);
		(&V_18)->___worldNormal_8 = L_67;
		PointerEventData_t9670F3C7D823CCB738A1604C72A1EB90292396FB* L_68 = ___eventData0;
		NullCheck(L_68);
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7 L_69;
		L_69 = PointerEventData_get_position_m5BE71C28EB72EFB8435749E4E6E839213AEF458C_inline(L_68, NULL);
		(&V_18)->___screenPosition_9 = L_69;
		int32_t L_70 = V_2;
		(&V_18)->___displayIndex_10 = L_70;
...
IL_0234:
	{
		...
		NullCheck(L_75);
		int32_t L_76;
		L_76 = Renderer_get_sortingLayerID_m3D7AE74F1B87099810CF969CB4520C85F9AE5F92(L_75, NULL);
		G_B22_0 = L_76;
		G_B22_1 = G_B21_0;
	}
...
IL_024f:
	{
		...
		NullCheck(L_79);
		int32_t L_80;
		L_80 = Renderer_get_sortingOrder_m4CE7ADEEC8E2F28CC1D10B1D4091A10F8F1583FA(L_79, NULL);
		G_B25_0 = L_80;
		G_B25_1 = G_B24_0;
	}
...
IL_0256:
	{
		...
		RaycastResult_tEC6A7B7CABA99C386F054F01E498AEC426CF8023 L_81 = V_18;
		V_14 = L_81;
		// resultAppendList.Add(result);
		List_1_t8292C421BBB00D7661DC07462822936152BAB446* L_82 = ___resultAppendList1;
		RaycastResult_tEC6A7B7CABA99C386F054F01E498AEC426CF8023 L_83 = V_14;
		NullCheck(L_82);
		List_1_Add_mEB6DFEA132B5B7BF540D34177054003185D250E7_inline(L_82, L_83, List_1_Add_mEB6DFEA132B5B7BF540D34177054003185D250E7_RuntimeMethod_var);
		// for (int b = 0, bmax = hitCount; b < bmax; ++b)
		int32_t L_84 = V_10;
